...
function showadminreply (divid) {
	...
	inputcontent+="<span class='replayits'>"+jslang[0]+"</span><br/><div class='ds-textarea-wrapper ds-rounded-top adds'><textarea cols='44' rows='10' name='adminreplycontent' class='comment_cont' placeholder='回复点什么吧' id='adminreplycontent"+cleanid+"'></textarea></div>";
...
function showadminreplyformessage (divid) {
	...
	inputcontent+="<span class='replayits'>"+jslang[0]+"</span><br/><div class='ds-textarea-wrapper ds-rounded-top adds'><textarea cols='44' rows='10' name='adminreplycontent'class='comment_cont'  id='adminreplycontent"+cleanid+"'></textarea></div>";
	inputcontent+="<input type='button' onclick=\"ajax_adminreply('"+cleanid+"'); return false;\" value='"+jslang[1]+"' class='button'/> <input type='reset' value='"+jslang[2]+"' class='button'/> <input type='button' value='"+jslang[3]+"'  onclick=\"hideadminreply('"+divid+"');\" class='button'/></form>";
	document.getElementById(divid).innerHTML=inputcontent;
	document.getElementById(divid).style.display='block';
}
